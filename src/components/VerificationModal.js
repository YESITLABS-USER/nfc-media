...
import { resendOtp, verifyOtp } from "../store/slices/userSlice";
const Verification = ({ isModalOpen, phone , setIsModalOpen }) => {
  ...
  const handleSubmit = () => {
    const finalData = {"otp": otp, "phone_number": phone}
        ...
        >
          ...
          >
            ...
            >
              ...
              <strong style={{ fontWeight: "bold" }}>{phone ?? "+1 999 999 9999"}</strong>
            </p>
            <div
              style={{
                display: "flex",
            ...
            <div style={{ fontSize: "16px", color: "#000000", marginTop: 10 }}>
              <p style={{ margin: "0", color: "#565656" }}>
                ...
                <strong
                  ...
                  onClick={() => {
                    if (!isDisable) {
                      dispatch(resendOtp({phone_number : phone}));
                      setTimeLeft(59);
                    }
                  }}
                >
